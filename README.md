...
## Selected Projects
- **PDF Merger Tool** — A Python-based desktop application with a graphical interface for merging and managing PDF files efficiently.
- **Image Scraper** — A Python web scraping tool designed to extract and download images based on user-defined input, demonstrating data extraction and automation workflows.
- **Library Management System** — A Java-based web application built using JSP, Servlets, and MySQL, implementing MVC architecture for managing library operations.

## Technical Skills
**Languages:** Python, Java, C, C++, JavaScript  
**Databases:** MySQL, SQLite, MongoDB  
**Libraries & Tools:** NumPy, Pandas, Selenium, tkinter, Git, GitHub  
**Frameworks (currently learning):** Django, FastAPI, Flask, Spring

## Approach
- Clean and readable code structure  
- Emphasis on fundamentals (OOP, data handling, backend logic)  
- Clear documentation and reproducible project setup  
